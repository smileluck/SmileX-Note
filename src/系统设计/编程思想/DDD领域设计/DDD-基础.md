...
![1704112743475](DDD-基础.assets/1704112743475.png)
...
- **聚合的特点**：**高内聚、低耦合**，它是领域模型中**最底层的边界**，可以作为拆分微服务的**最小单位**，但我不建议你对微服务过度拆分。但在对性能有极致要求的场景中，聚合可以独立作为一个微服务，以满足版本的高频发布和极致的弹性伸缩能力。 
