...
## 序列化对应在TCP/IP 4层模型的哪一层

![1708779741372](rpc-序列化和反序列化.assets\1708779741372.png)
...
## JDK 自带的序列化 Serializable

只需要实现 `Serializable` 接口。
...
### SerialVersionUID作用
 ...
 [SerialVersionUID.md](..\..\basic\序列化和反序列化\SerialVersionUID.md) 
...
- 存在安全问题 ：序列化和反序列化本身并不存在问题。但当输入的反序列化的数据可被用户控制，那么攻击者即可通过构造恶意输入，让反序列化产生非预期的对象，在此过程中执行构造的任意代码。相关阅读：[应用安全:JAVA反序列化漏洞之殇 - Cryin](https://cryin.github.io/blog/secure-development-java-deserialization-vulnerability/) 、[Java反序列化安全漏洞怎么回事? - Monica](https://www.zhihu.com/question/37562657/answer/1916596031)。化
...
![1713261417416](rpc-序列化和反序列化.assets/1713261417416.png)
...
![img](rpc-序列化和反序列化.assets/569e541a-22b2-4846-aa07-0ad479f07440.png)
...
- 使用Dubbo中SPI机制，实现了按需加载实现类、根据别名获取实现类。有一篇博文比较详细：https://developer.aliyun.com/article/891913#slide-11