...
<mark>经过系统的，就算没有处理，也默认要卷一个$\delta(t)$</mark>
...
1. 微分性质
   ...
   $$
   \frac{\mathrm{d}^{n}}{\mathrm{d} t} [f_1(t)*f_2(t)]=\frac{\mathrm{d}^{n}f_1(t)}{\mathrm{d} t} *f_2(t)=f_1(t)*\frac{\mathrm{d}^{n}f_2(t)}{\mathrm{d} t} 
   $$
